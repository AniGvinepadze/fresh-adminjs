...
apiRouter.get('/services', async (req, res) => {
    ...
    try {
        ...
        const responseData = services.map((service) => ({
            ...
            restaurant_and_bars_section_little_description: service[`restaurant_and_bars_section_little_description_${language}`],
            ...
            meetings_and_events_section_little_description: service[`meetings_and_events_section_little_description_${language}`],
...
apiRouter.get('/meetings-events', async (req, res) => {
    ...
    try {
        ...
        const responseData = meetingEvents.map((event) => ({
            ...
            conference_ballroom_section_little_description: event[`conference_ballroom_section_little_description_${language}`],
